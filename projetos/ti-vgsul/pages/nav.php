...
<div class="container-centro">
  ...
  <p class="brasao-titulo h5">Prefeitura Municipal de Vargem Grande do Sul</p>
  <p class="brasao-cognome h4">"A Pérola da Mantiqueira"</p>

</div>

<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="home.php">Divisão de Informática</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="arps.php">ARPs</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="chamados.php">Chamados</a></li>
            <li><a class="dropdown-item" href="downloads.php">Downloads</a></li>
            <li><a class="dropdown-item" href="enderecos.php">Endereços Eletrônicos</a></li>
